define(['UILayer', getViewTemplatePath('ui/ui.radio.list'), 'UIScroll'], function (UILayer, template, UIScroll) {
  ...
  return _.inherit(UILayer, {
    propertys: function ($super) {
      ...
      this.events = {
        'click .form-item-list> li': 'clickAction'
      };
...
//      if (!this.datamodel.selectId) return;
    ...
    initElement: function () {
      this.swrapper = this.$('.pop-box-bd');
      this.scroller = this.$('.form-item-list');
