define(['View',getViewTemplatePath('empDetail'),'MyInfoModel','HRempDetailModel','MyInfoDetailListStore','MyProfileStore','UILoading','UIToast','LanguageStore','UIRadioList','MyInfoSaveModel'],function(View,viewhtml,MyInfoModel,HRempDetailModel,MyInfoDetailListStore,MyProfileStore,UILoading,UIToast,LanguageStore,UIRadioList,MyInfoSaveModel){
    ...
    var hrEmpDetailModel = HRempDetailModel.getInstance();
    var empId = location.href.substring(location.href.indexOf("&")+1,location.href.length);
    var selectHeadCN = [
        {"id":"1","name":"拍照"},
        {"id":"2","name":"从手机获取"}
    ];
    ...
    return _.inherit(View,{
        onCreate: function () {
            ...
            //this.$el.html(_.template(viewhtml)({
            //    'title':'123'
            //}));
            if (!this.toast1) {
            ...
            myInfomodel.execute(function(data){
                    ...
                    $(".ctui-itmes").html(_.template(this.els.OutLineInfo_tpl.html())({'data':data.data.ee_info}));
                },
                function(e){
